...
cat ${inp}_1 ${inp}_2 ${inp}_3 ${inp}_4 ${inp}_5 ${inp}_6 ${inp}_7 ${inp}_8 ${inp}_9 ${inp}_10 ${inp}_11 ${inp}_12 > ${inp}.fa

rm ${inp}_1 ${inp}_2 ${inp}_3 ${inp}_4 ${inp}_5 ${inp}_6 ${inp}_7 ${inp}_8 ${inp}_9 ${inp}_10 ${inp}_11 ${inp}_12
